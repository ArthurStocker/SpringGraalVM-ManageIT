...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    SpringApplicationBuilder child = parent.child(Repository.class).web(WebApplicationType.NONE);
    child.application().addInitializers(new ApplicationInitializer());

    SpringApplicationBuilder sibling = child.sibling(Webapplication.class).web(WebApplicationType.SERVLET);
