 ...
 */
@Controller
@ComponentScan(basePackages = { "org.manageit.*" })
public class Broker {
  ...
  */
  ...
  @RequestMapping(value = "/{module}/{member}", method = RequestMethod.GET) //produces = "text/plain"
	public ResponseEntity<String> dispatch(HttpServletRequest request, @PathVariable("module") String module, @PathVariable("member") String member) {
